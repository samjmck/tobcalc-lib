import {
	...
	getTaxFormData,
	getDefaultTaxRate, fillPdf,
} from "../src/export.ts";

// Convert csv data to a Blob
const trading212Csv = `Action,Time,ISIN,Ticker,Name,No. of shares,Price / share,Currency (Price / share),Exchange rate,Result (EUR),Total (EUR),Withholding tax,Currency (Withholding tax),ID,Currency conversion fee (EUR)
...
const fillablePdf = "https://jsr.io/@samjmck/tobcalc-lib/1.0.1/pdfs/build/TD-OB1-DE-empty-fillable-pdfa.pdf";
