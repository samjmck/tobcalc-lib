...
import { getDefaultTaxRate, getTaxableTransactions, getTaxFormData } from "../src/tax.ts";
...
async function getSecuritiesMap(isins: string[]): Promise<Map<string, Security>> {
...
const taxableTransactions = await getTaxableTransactions(brokerTransactions, getSecuritiesMap);
