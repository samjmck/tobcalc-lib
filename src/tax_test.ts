...
Deno.test({
  ...
  fn: async () => {
    ...
    assertEquals(
      isNameRegistered("Vanguard FTSE All-World UCITS ETF Acc"),
      false,
    );
  },
});
...
Deno.test({
  name:
    "broker transactions -> taxable transactions with exchange rates and security types",
  permissions: {
    net: true,
  },
  fn: async () => {
...
Deno.test({
  ...
  fn: () => {
    assertEquals(
      getDefaultTaxRate({ // ETF in EEA, accumulating
        value: -100_00,
        security: {
          name: "",
          type: SecurityType.ETF,
    ...
    assertEquals(
      getDefaultTaxRate({ // ETF in EEA, distributing
        value: -100_00,
        security: {
          name: "",
          type: SecurityType.ETF,
    ...
    assertEquals(
      getDefaultTaxRate({ // ETF not in EEA, accumulating
        value: -100_00,
        security: {
          name: "",
          type: SecurityType.ETF,
    ...
    assertEquals(
      getDefaultTaxRate({ // ETF not in EEA, distributing
        value: -100_00,
        security: {
          name: "",
          type: SecurityType.ETF,
    ...
    assertEquals(
      getDefaultTaxRate({ // ETF in Belgium, accumulating
        value: -100_00,
        security: {
          name: "",
          type: SecurityType.ETF,
    ...
    assertEquals(
      getDefaultTaxRate({ // ETF in Belgium, distributing
        value: -100_00,
        security: {
          name: "",
          type: SecurityType.ETF,
